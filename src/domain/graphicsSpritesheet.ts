...
export const graphicsSpritesheetFrames = {
  arrow1: { x: 780, y: 670, width: 61, height: 253, pivotX: 29.2, pivotY: 180 },
  arrow2: { x: 848, y: 670, width: 55, height: 264, pivotX: 26.25, pivotY: 180 },
  arrow3: { x: 910, y: 670, width: 41, height: 256, pivotX: 20.35, pivotY: 180 },
  arrow4: { x: 958, y: 670, width: 50, height: 286, pivotX: 24.5, pivotY: 180 },
  device: { x: 20, y: 20, width: 549, height: 593, pivotX: 272, pivotY: 315 },
  glare: { x: 640, y: 20, width: 328, height: 328, pivotX: 165, pivotY: 166 },
